...
const genesisBlock: Block = new Block(0, "20201010", "", "hello", 1234556);
...
const getHashforBlock = (aBlock: Block): string => Block.calculateBlockHash(aBlock.index, aBlock.previousHash,
    aBlock.timestamp, aBlock.data)
